...
public class RegenerationActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.regeneration);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button31.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), RegeneratioActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button32.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), Regeneration2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button33.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), Regeneration3Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button38.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashRegenerationActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button39.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashRegeneration2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button40.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashRegeneration3Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button34.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringRegenerationActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button35.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringRegeneration2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button36.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringRegeneration3Activity.class);
					startActivity(i);
				}
			}
		});
