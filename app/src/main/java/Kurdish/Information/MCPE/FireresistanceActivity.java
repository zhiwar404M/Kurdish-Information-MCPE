...
public class FireresistanceActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.fireresistance);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button31.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), FireActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button32.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), FireResistance2lActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button38.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashFireActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button39.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashFire2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button34.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringFireActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button36.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringFire2Activity.class);
					startActivity(i);
				}
			}
		});
