	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button31.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), NightActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button32.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), NightVision2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button38.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashNightActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button39.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashNight2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button34.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringNightActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button35.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringNight2Activity.class);
					startActivity(i);
				}
			}
		});
