...
public class SlownessActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.slowness);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button31.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), Slowness1Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button32.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), Slowness2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button38.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					SketchwareUtil.showMessage(getApplicationContext(), "لە ئێستادا ئەم بەشە لەبەردەست نیە");
				}
			}
		});
