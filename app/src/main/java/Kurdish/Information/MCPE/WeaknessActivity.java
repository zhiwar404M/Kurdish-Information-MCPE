...
public class WeaknessActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.weakness);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button31.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), Weakness1Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button32.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), Weakness2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button38.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashWeaknessActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button39.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashWeakness2Activity.class);
					startActivity(i);
				}
			}
		});
		...
		button34.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringWeaknessActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button35.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringWeakness2Activity.class);
					startActivity(i);
				}
			}
		});
