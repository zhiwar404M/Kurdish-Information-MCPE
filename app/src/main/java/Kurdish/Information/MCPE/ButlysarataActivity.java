...
public class ButlysarataActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.butlysarata);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button31.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), AwkwardActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button42.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), ThickActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button33.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), MundaneActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button39.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashAwkwardActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button40.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), SplashMundaneActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button35.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringawkwardActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button41.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringThickActivity.class);
					startActivity(i);
				}
			}
		});
		...
		button36.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (true) {
					i.setClass(getApplicationContext(), LingeringMundaneActivity.class);
					startActivity(i);
				}
			}
		});
